...
<div id="mainbody">
    ...
    <div id="bodybody">
	    ...
	    <table class="mainregist">
        	...
        	<tr class="ktext"><th class="tbwidth">QQ：</th><th><input name="qq" type="text" id="qq" class="rtext" placeholder="请输入QQ号"/><span id="qspan" class="warm"></span></th></tr>
       		<tr><th colspan="2" align="center"><input type="submit" name="registtext" class="rgone" value="注册"/><a href="login.html" class="tologin">返回登录</a></th></tr>
    	</table></form>
    </div>
